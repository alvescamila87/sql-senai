...
CREATE TABLE `filho` (
  ...
  KEY `pai_id` (`pai_id`),
  CONSTRAINT `filho_ibfk_1` FOREIGN KEY (`pai_id`) REFERENCES `pai` (`pai_id`)
...
INSERT INTO `filho` VALUES (1,1,'Lucas',20),(2,1,'Matheus',18),(3,2,'Gabriel',15),(4,3,'Rafael',22),(5,4,'Gustavo',17);
